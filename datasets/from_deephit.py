...
- Based on the data, create mask1 and mask2 that are required to calculate loss functions.
'''
...
def load_synthetic(norm_mode='standard'):

    PATH_ROOT = Path(TFCox.__file__).parent
    PATH_DATA = PATH_ROOT/'datasets'
    in_filename = PATH_DATA/'synthetic/synthetic_comprisk.csv'
